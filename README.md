...
- **Claude Code & Vercel**  
  Debugging, refactoring, run token-efficient engineering support
...
The emphasis throughout was **system user behavior and incentive alignment**, not visual polish.
